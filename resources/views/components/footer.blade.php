<footer
    style="background-image:url('{{asset('img/landing-bg.png')}}')"

    class="text-white dark:bg-gray-900"
>
    <div class="container py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0 flex justify-center">
                <a href="/" class="flexflex-col items-center">
                    <svg
                        class="w-56"
                        id="Layer_2"
                        data-name="Layer 2"
                    ...
                    <div
                        class="text-center text-2xl md:text-xs md:pl-0 font-normal whitespace-nowrap dark:text-white"
                    >
                        ..care at it's best..
                    </div>
                </a>
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <ul class="font-medium">
                        <li>
                            <a href="/services/complex-care" class="hover:underline"
                            >Complex Care</a
                            >
                        </li>
                        <li>
                            <a href="/services/live-in-care" class="hover:underline"
                            >Live-In-Care</a
                            >
                        </li>
                        <li>
                            <a href="/services/home-care" class="hover:underline"
                            >Home Care</a
                            >
                        </li>
                        <li>
                            <a href="/services/private-care" class="hover:underline"
                            >Private Care</a
                            >
                        </li>
                        <li>
                            <a
                                href="/services/one-to-one-care"
                        ...
                        <li>
                            <a
                                href="/services/supported-living-service"
                                class="hover:underline"
                            >
                ...
                <div>
                    <h2
                        ...
                        data-aos-duration="800"
                        data-aos-delay="300"
                        class="mb-3 text-sm font-semibold dark:text-white"
                    >
                        Policies
                    </h2>
                    <ul class="font-medium">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
              ...
              >© 2024
                ...
                >Caring Hands International Limited</a
                >. All Rights Reserved.
              </span>
            <div class="flex space-x-2 md:space-x-9">
                ...
                <a
                    ...
                    target="_blank"
                    class="transition duration-300 hover:scale-110 w-5 h-5 text-gray-100 hover:text-red-400 inline-block"
                    title="Facebook"
                >
                    <svg
