            ...
            <div class="px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div class="mb-4">
                    <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                        <p class="text-base font-semibold uppercase tracking-wide text-chil-blue dark:text-blue-200">
                            Contact
                        </p>
                        <h2
                            class="font-heading mb-4 text-3xl font-bold tracking-tight text-chil-red dark:text-white sm:text-5xl">
                            Get in Touch
                        </h2>
                        <p class="dark:text-slate-400 mx-auto mt-4 max-w-3xl text-xl text-gray-600">
                            We always care!
                        </p>
                    </div>
                </div>
                ...
                <address class="mx-auto w-full">
                    <div class="flex flex-col items-center justify-center">
                        <h3 class="mb-2 text-lg font-medium not-italic leading-6 text-chil-blue">
                            Our Address
                        </h3>
                    </div>
                    <div class="mb-4 ml-4">
                        <div class="border border-chil-blue">
                            <iframe
                                ...
                                style="border: 0; width: 100%" height="600" allowfullscreen="" loading="lazy"
                    ...
                    <div class="">
                        <div class="h-full pr-6">
                            <ul class="my-6 md:mb-0">
                                <li class="flex">
                                    <div
                                        ...
                                        <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="24"
                                    ...
                                    <div class="mb-4 ml-4">
                                        ...
                                        <p class="border-chil-blue font-semibold text-chil-blue hover:text-chil-red">
                                            <a href="tel:03438410111">Click To Call </a>
                                        </p>
                                        <p class="border-chil-blue font-semibold text-chil-blue hover:text-chil-red">
                            ...
                            <div class="p-4 shadow-xl">
                                <h2 class="mb-4 text-center font-bold text-chil-red">
                                    Follow Us
                                </h2>
                                <div class="flex justify-center space-x-2 md:space-x-9">
                                    <!-- Facebook -->
                                    <a class="inline-block h-16 w-16 text-gray-100 transition duration-300 hover:scale-110 hover:text-red-400"
                                        href="https://www.facebook.com/share/XhtKHixCKrmAmboF/" title="Facebook"
                                        target="_blank">
                                        <svg aria-labelledby="title" viewBox="126.445 2.281 589 589"
                                    ...
                                    <a class="inline-block h-16 w-16 text-gray-100 transition duration-300 hover:scale-110 hover:text-red-400"
                                        ...
                                        <svg aria-labelledby="title desc" viewBox="0 0 3364.7 3364.7"
                                            xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <defs>
                                                ...
                                                <radialGradient id="1" cx="2330.61" cy="3182.95"
                                                    r="3759.33" gradientUnits="userSpaceOnUse">
                                    ...
                                    <a class="inline-block h-16 w-16 text-gray-100 transition duration-300 hover:scale-110 hover:text-red-400"
                                        ...
                                        <svg aria-labelledby="title desc" viewBox="-2.73 0 1225.016 1225.016"
                                            ...
                                            <linearGradient id="a" gradientUnits="userSpaceOnUse"
                                                x1="609.77" y1="1190.114" x2="609.77" y2="21.084">
