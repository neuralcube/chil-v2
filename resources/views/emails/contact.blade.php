...
-->
    ...
    <body class="body">
        <div class="es-wrapper-color" dir="ltr">
            <!--[if gte mso 9]>
                ...
                <tbody>
                    <tr>
                        <td class="esd-email-paddings" valign="top">
                                    ...
                                    <tr>
                                        <td class="esd-stripe" align="center">
                                            <table class="es-header-body" width="600" cellspacing="0" cellpadding="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="es-p20t es-p20r es-p20l esd-structure"
                                                            align="left">
                                                                    ...
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560"
                                                                            ...
                                                                            <table width="100%" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-image es-p5"
                                                                                            style="font-size:0"
                                                                                            align="center">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="esd-stripe" align="center" bgcolor="transparent">
                                            <table class="es-content-body" width="600" cellpadding="0"
                                                cellspacing="0" bgcolor="#ffffff" align="center">
                                                <tbody>
                                                    <tr>
                                                        <td class="esd-structure es-p20r es-p20l es-p5t es-p5b"
                                                            style="background-color:#0b5394" align="left"
                                                            bgcolor="#0b5394">
                                                                    ...
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560"
                                                                            ...
                                                                            <table role="presentation" cellpadding="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-text-6855"
                                                                                            align="center">
                                                                                            <h1 class="es-override-size es-text-mobile-size-24 es-m-txt-c"
                                                                                                style="color:#efefef;font-family:verdana,geneva,sans-serif">
                                                                                                <strong>Contact Has Been
                                                                                                    Made!</strong>
                                                                                            </h1>
                                                                                        </td>
                                                                                    </tr>
                                        ...
                                        <td class="esd-stripe" align="center">
                                            <table class="es-content-body" width="600" cellspacing="0"
                                                ...
                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560"
                                                                            ...
                                                                            <table width="100%" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-text-1592"
                                                                                            align="left">
                                                                    ...
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560"
                                                                            ...
                                                                            <table role="presentation" cellpadding="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-text-9194"
                                                                                            align="left">
                                                    ...
                                                    <tr>
                                                        <td class="esd-structure es-p20r es-p20l es-p5t"
                                                            align="left">
                                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560"
                                                                            ...
                                                                            <table role="presentation" cellpadding="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-text-2649"
                                                                                            align="left">
                            ...
                            <table class="esd-footer-popover es-footer" cellspacing="0" cellpadding="0"
                                align="center">
                                <tbody>
                                    <tr>
                                        <td class="esd-stripe" align="center">
                                            <table class="es-footer-body" width="600" cellspacing="0"
                                                cellpadding="0" bgcolor="#ffffff" align="center">
                                                <tbody>
                                                    <tr>
                                                        <td class="esd-structure es-p20l es-p20r es-p20t es-p5b"
                                                            align="left">
                                                            <table class="es-left" cellspacing="0" cellpadding="0"
                                                                align="left">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560"
                                                                            ...
                                                                            <table width="100%" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-text-7996"
                                                                                            align="left">
                                                                                            <h2 class="es-text-mobile-size-18"
                                                                                                style="color:#800;font-size:18px">
                                                                    ...
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560"
                                                                            ...
                                                                            <table role="presentation" cellpadding="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-text-9604"
                                                                                            align="left">
                                                                    ...
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560"
                                                                            ...
                                                                            <table role="presentation" cellpadding="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-text-2376"
                                                                                            align="left">
                                                                                            <p class="es-text-mobile-size-18"
                                                                                                style="font-size:18px;color:#800">
                                    ...
                                    <tr>
                                        <td class="esd-stripe" align="center" bgcolor="transparent">
                                            <table class="es-content-body" width="600" cellpadding="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="esd-structure es-p20r es-p20l es-p20b"
                                                            align="left">
                                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="560"
                                                                            ...
                                                                            <table role="presentation" cellpadding="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-text-4385"
                                                                                            align="left">
                                                                                            <p class="es-text-mobile-size-16"
                                                                                                style="font-size:16px;line-height:150% !important;font-family:verdana,geneva,sans-serif">
                                                                                                {{ $details['message'] }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
